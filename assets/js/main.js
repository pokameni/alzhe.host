...
"use strict";$(".main-slider").slick({infinite:!0,speed:1e3,autoplay:!1,autoplaySpeed:4e3,slidesToShow:1,slidesToScroll:1,dots:!0,arrows:!1,fade:!0}),$(window).on("load",function(){var t=$("#d-toggle"),e=$(".pricing-price .duration",".pricing-box");t.on("click",function(){if($(".fd",this).toggleClass("active"),$(".button",this).toggleClass("on"),$(".sd",this).toggleClass("active"),e.hasClass("annouly")){e.text("/mo");for(var t=0;t<=2;t++)$(".pricing-box:eq("+t+") .num").text(parseFloat(Number($(".pricing-box:eq("+t+") .num").text())/12).toFixed(2))}else{e.text("/yr");for(var t=0;t<=2;t++)$(".pricing-box:eq("+t+") .num").text(parseFloat(12*Number($(".pricing-box:eq("+t+") .num").text())).toFixed(2))}e.toggleClass("annouly")}),$("a[href*=\\#]").on("click",function(t){t.preventDefault();var e=0;"#"!=$(this).attr("href")&&(e=$(this.hash).offset().top),$("html,body").animate({scrollTop:e},500)});var o=$(".photo-holder.photo1",".text-photo-sc"),i=$(".text-holder.text1",".text-photo-sc"),s=$(".photo-holder.photo2",".text-photo-sc"),h=$(".text-holder.text2",".text-photo-sc");$(window).width()>990&&(o.css("height",i.height()),s.css("height",h.height())),$(window).on("resize",function(){return $(window).width()>990&&(o.css("height",i.height()),s.css("height",h.height())),!1})});
function checkStatus() {
	...
	xhr.open("GET", "https://panel.alzhe.me", true);
	xhr.send();
}